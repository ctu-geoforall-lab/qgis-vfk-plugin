...
class Ui_MainApp(object):
    def setupUi(self, MainApp):
        ...
        self.scrollAreaWidgetContents_5.setGeometry(QtCore.QRect(0, 0, 411, 291))
        ...
        self.actionDownloadAllPosidents.setIcon(icon9)
        self.actionDownloadAllPosidents.setObjectName("actionDownloadAllPosidents")
    ...
    def retranslateUi(self, MainApp):
        ...
        self.actionDownloadAllPosidents.setText(_translate("MainApp", "downloadAllPosidents"))
        self.actionDownloadAllPosidents.setToolTip(_translate("MainApp", "Stáhnout všechny posidenty z katastru"))
