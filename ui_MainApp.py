...
class Ui_MainApp(object):
    def setupUi(self, MainApp):
        ...
        self.scrollAreaWidgetContents_5.setGeometry(QtCore.QRect(0, 0, 454, 371))
        ...
        self.posidentPage = QtWidgets.QWidget()
        self.posidentPage.setObjectName("posidentPage")
        self.gridLayout_101 = QtWidgets.QGridLayout(self.posidentPage)
        self.gridLayout_101.setContentsMargins(11, 11, 11, 11)
        self.gridLayout_101.setSpacing(6)
        self.gridLayout_101.setObjectName("gridLayout_101")
        self.scrollArea_7 = QtWidgets.QScrollArea(self.posidentPage)
        self.scrollArea_7.setEnabled(True)
        self.scrollArea_7.setWidgetResizable(True)
        self.scrollArea_7.setObjectName("scrollArea_7")
        self.scrollAreaWidgetContents_7 = QtWidgets.QWidget()
        self.scrollAreaWidgetContents_7.setGeometry(QtCore.QRect(0, 0, 454, 371))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.verticalLayout = QtWidgets.QVBoxLayout(self.scrollAreaWidgetContents_7)
        self.verticalLayout.setContentsMargins(11, 11, 11, 11)
        self.verticalLayout.setSpacing(6)
        self.verticalLayout.setObjectName("verticalLayout")
        self.widget_4 = QtWidgets.QWidget(self.scrollAreaWidgetContents_7)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.wsdpStatus = QtWidgets.QLabel(self.widget_4)
        self.wsdpStatus.setText("")
        self.wsdpStatus.setObjectName("wsdpStatus")
        self.gridLayout_19.addWidget(self.wsdpStatus, 4, 0, 1, 1)
        spacerItem4 = QtWidgets.QSpacerItem(20, 119, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_19.addItem(spacerItem4, 3, 0, 1, 2)
        self.horizontalLayout_7 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_7.setSpacing(6)
        self.horizontalLayout_7.setObjectName("horizontalLayout_7")
        self.wsdpProgressBar = QtWidgets.QProgressBar(self.widget_4)
        self.wsdpProgressBar.setProperty("value", 0)
        self.wsdpProgressBar.setObjectName("wsdpProgressBar")
        self.horizontalLayout_7.addWidget(self.wsdpProgressBar)
        self.wsdpQueryButton = QtWidgets.QPushButton(self.widget_4)
        self.wsdpQueryButton.setObjectName("wsdpQueryButton")
        self.horizontalLayout_7.addWidget(self.wsdpQueryButton)
        self.gridLayout_19.addLayout(self.horizontalLayout_7, 5, 0, 1, 2)
        ...
        self.wsdpPassword = gui.QgsPasswordLineEdit(self.widget_4)
        self.wsdpPassword.setObjectName("wsdpPassword")
        self.gridLayout_18.addWidget(self.wsdpPassword, 2, 1, 1, 1)
        self.label_8 = QtWidgets.QLabel(self.widget_4)
        self.label_8.setObjectName("label_8")
        self.gridLayout_18.addWidget(self.label_8, 2, 0, 1, 1)
        self.wsdpUsername = QtWidgets.QLineEdit(self.widget_4)
        self.wsdpUsername.setObjectName("wsdpUsername")
        self.gridLayout_18.addWidget(self.wsdpUsername, 0, 1, 1, 1)
        self.gridLayout_19.addLayout(self.gridLayout_18, 0, 0, 1, 2)
        self.wsdpTestButton = QtWidgets.QPushButton(self.widget_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.wsdpTestButton.sizePolicy().hasHeightForWidth())
        self.wsdpTestButton.setSizePolicy(sizePolicy)
        self.wsdpTestButton.setObjectName("wsdpTestButton")
        self.gridLayout_19.addWidget(self.wsdpTestButton, 1, 1, 1, 1)
        spacerItem5 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_19.addItem(spacerItem5, 1, 0, 1, 1)
        self.verticalLayout.addWidget(self.widget_4)
        self.scrollArea_7.setWidget(self.scrollAreaWidgetContents_7)
        self.gridLayout_101.addWidget(self.scrollArea_7, 0, 0, 1, 1)
        self.stackedWidget.addWidget(self.posidentPage)
        ...
        self.actionImport.setChecked(True)
        icon1 = QtGui.QIcon()
        ...
        self.actionDownloadPosidents = QtWidgets.QAction(MainApp)
        self.actionDownloadPosidents.setCheckable(True)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/downloadAllPosidents.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionDownloadPosidents.setIcon(icon9)
        self.actionDownloadPosidents.setObjectName("actionDownloadPosidents")
        self.actionZpracujZmeny = QtWidgets.QAction(MainApp)
        self.actionZpracujZmeny.setCheckable(True)
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/applyChanges.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionZpracujZmeny.setIcon(icon10)
        self.actionZpracujZmeny.setObjectName("actionZpracujZmeny")

        self.retranslateUi(MainApp)
        self.stackedWidget.setCurrentIndex(0)
        self.searchForms.setCurrentIndex(3)
    ...
    def retranslateUi(self, MainApp):
        ...
        self.overwriteCheckBox.setText(_translate("MainApp", "Přepsat interní VFK databázi"))
        ...
        self.wsdpQueryButton.setText(_translate("MainApp", "Získej posidenty"))
        self.label_7.setText(_translate("MainApp", "Uživatelské jméno:"))
        self.wsdpPassword.setText(_translate("MainApp", "WSHESLO"))
        self.label_8.setText(_translate("MainApp", "Heslo:"))
        self.wsdpUsername.setText(_translate("MainApp", "WSTEST"))
        self.wsdpTestButton.setText(_translate("MainApp", "Otestuj přístupové údaje CtiOS"))
        ...
        self.actionDownloadPosidents.setText(_translate("MainApp", "downloadPosidents"))
        self.actionDownloadPosidents.setToolTip(_translate("MainApp", "Stáhnout posidenty pro vybrané budovy a parcely"))
